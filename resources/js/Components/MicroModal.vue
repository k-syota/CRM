...
<template>
    <div v-show="isShow" class="modal" id="modal-1" aria-hidden="true">
        <div class="modal__overlay" tabindex="-1" data-micromodal-close>
            ...
            <footer class="modal__footer">
                ...
                data-micromodal-close aria-label="Close this dialog window" @click="toggleStatus">
                    Close
                </button>
            </footer>
            </div>
    ...
    class="flex mx-auto text-white bg-teal-500 border-0 py-2 px-8 mt-2 focus:outline-none hover:bg-teal-600 rounded text-lg">
    検索
    </button>
</template>
